...
| **[DIDComm Go](https://github.com/decentralized-identity/didcomm-go)** | [![GitHub stars](https://img.shields.io/github/stars/decentralized-identity/didcomm-go?style=social&color=white)](https://github.com/decentralized-identity/didcomm-go/stargazers) | Go implementation of the DIDComm messaging protocol for encrypted, peer-to-peer decentralized communication. |
